...
def main():
    ...
    if article:
        ...
        # JSONファイルに保存
        with open('/Users/g.ohorudingusu/Docbase/article_664151_backup.json', 'w', encoding='utf-8') as f:
            json.dump(article, f, ensure_ascii=False, indent=2)
        print("\n記事の内容を article_664151_backup.json に保存しました")
    else:
        print("記事を取得できませんでした")
